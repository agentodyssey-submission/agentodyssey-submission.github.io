    ...
    <section className={styles.hero}>
      <div className={`container ${styles.heroContent}`}>
        <div className={styles.heroTitleRow}>
          <img src={logoUrl} alt="AgentOdyssey logo" className={styles.heroLogo} />
        ...
        <div className={styles.linkRow}>
          <a className={`${styles.linkButton} ${styles.linkButtonGreen}`} href={demoUrl}>
            🎮 Interactive Demo
          </a>
        </div>
        <TerminalDemo />
...
function Overview() {
  ...
  const videoUrl = useBaseUrl('/video/teaser_video.mp4');
      ...
      <div className="container">
        <RevealSection>
          <div className={styles.demoCtaWrapper}>
            <a href={demoUrl} className={styles.demoCta}>
          ...
          {HIGHLIGHTS.map((item, i) => (
            <RevealSection key={item.title} delay={i * 120}>
              ...
              >
                <h3>{item.title}</h3>
                {item.img ? (
                  <img src={withBaseUrl(item.img)} alt={item.title} className={styles.highlightImg} />
                ) : (
                  <p>{item.desc}</p>
                )}
              </div>
...
function Findings() {
  const leaderboardUrl = useBaseUrl('/img/leaderboard.png');
  const gameProgressUrl = useBaseUrl('/img/game_progress.png');
  const diagnosticUrl = useBaseUrl('/img/diagnostic_results.png');
  return (
    <section className={styles.sectionAlt}>
      <div className="container">
        <RevealSection>
        ...
        <RevealSection>
          <div className={styles.resultsImageWrapper}>
            <img src={leaderboardUrl} alt="Leaderboard" className={styles.resultsImage} />
        ...
        <RevealSection>
          <div className={styles.resultsImageWrapper}>
            <img src={gameProgressUrl} alt="Game Progress Results" className={styles.resultsImage} />
...
reward used as a tiebreaker.</p>
                ...
                <RevealSection>
          <div className={styles.resultsImageWrapper}>
            <img src={diagnosticUrl} alt="Diagnostic Results" className={styles.resultsImage} />
